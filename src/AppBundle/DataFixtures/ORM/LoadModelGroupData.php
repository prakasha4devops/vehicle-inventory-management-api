...
use IMS\CommonBundle\Entity\ModelGroup;
use AppBundle\DataFixtures\BaseFixture;
use Doctrine\Common\DataFixtures\OrderedFixtureInterface;
use Doctrine\Common\Persistence\ObjectManager;

class LoadModelGroupData extends BaseFixture implements OrderedFixtureInterface
{
    /**
    ...
    public function load(ObjectManager $manager)
    {
        ...
        for ($i = 0; $i < 30; $i++) {
            ...
            $this->addReference('IMS_CommonBundle_Entity_ModelGroup'.$i, $entity);
        }
