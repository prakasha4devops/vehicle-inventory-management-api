...
class LoadTrimData extends BaseFixture implements OrderedFixtureInterface
{
    /**
    ...
    public function load(ObjectManager $manager)
    {
        ...
        for ($i = 0; $i < 30; $i++) {
            ...
            $entity->setName($this->randomPronounceableWord(1, 8));
            $entity->setDateAdded(new \DateTime());
            $entity->setDateUpdated(new \DateTime());
            $entity->setIsVerified(mt_rand(1,100));
            $entity->setStatus(1);
            
            $manager->persist($entity);
            $this->addReference('IMS_CommonBundle_Entity_Trim'.$i, $entity);
        }
