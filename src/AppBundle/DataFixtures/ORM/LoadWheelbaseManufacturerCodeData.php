...
use IMS\CommonBundle\Entity\WheelbaseManufacturerCode;
use AppBundle\DataFixtures\BaseFixture;
use Doctrine\Common\DataFixtures\OrderedFixtureInterface;
use Doctrine\Common\Persistence\ObjectManager;

class LoadWheelbaseManufacturerCodeData extends BaseFixture implements OrderedFixtureInterface
{
    /**
    ...
    public function load(ObjectManager $manager)
    {
        ...
        for ($i = 0; $i < 30; $i++) {
            $entity = new WheelbaseManufacturerCode();
            ...
            $this->addReference('IMS_CommonBundle_Entity_WheelbaseManufacturerCode'.$i, $entity);
        }
