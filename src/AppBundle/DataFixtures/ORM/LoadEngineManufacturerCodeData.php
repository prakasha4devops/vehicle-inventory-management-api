...
use IMS\CommonBundle\Entity\EngineManufacturerCode;
use AppBundle\DataFixtures\BaseFixture;
use Doctrine\Common\DataFixtures\OrderedFixtureInterface;
use Doctrine\Common\Persistence\ObjectManager;

class LoadEngineManufacturerCodeData extends BaseFixture implements OrderedFixtureInterface
{
    /**
    ...
    public function load(ObjectManager $manager)
    {
        ...
        for ($i = 0; $i < 30; $i++) {
            $entity = new EngineManufacturerCode();
            ...
            $this->addReference('IMS_CommonBundle_Entity_EngineManufacturerCode'.$i, $entity);
        }
