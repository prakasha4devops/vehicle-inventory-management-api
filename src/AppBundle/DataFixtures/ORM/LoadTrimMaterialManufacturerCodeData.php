...
use IMS\CommonBundle\Entity\TrimMaterialManufacturerCode;
use AppBundle\DataFixtures\BaseFixture;
use Doctrine\Common\DataFixtures\OrderedFixtureInterface;
use Doctrine\Common\Persistence\ObjectManager;

class LoadTrimMaterialManufacturerCodeData extends BaseFixture implements OrderedFixtureInterface
{
    /**
    ...
    public function load(ObjectManager $manager)
    {
        ...
        for ($i = 0; $i < 30; $i++) {
            $entity = new TrimMaterialManufacturerCode();
            ...
            $this->addReference('IMS_CommonBundle_Entity_TrimMaterialManufacturerCode'.$i, $entity);
        }
