...
use IMS\CommonBundle\Entity\TransmissionManufacturerCode;
use AppBundle\DataFixtures\BaseFixture;
use Doctrine\Common\DataFixtures\OrderedFixtureInterface;
use Doctrine\Common\Persistence\ObjectManager;

class LoadTransmissionManufacturerCodeData extends BaseFixture implements OrderedFixtureInterface
{
    /**
    ...
    public function load(ObjectManager $manager)
    {
        ...
        for ($i = 0; $i < 30; $i++) {
            $entity = new TransmissionManufacturerCode();
            ...
            $this->addReference('IMS_CommonBundle_Entity_TransmissionManufacturerCode'.$i, $entity);
        }
