...
use Mockery as m;
use ApiBundle\Handler\TransmissionHandler;
use IMS\CommonBundle\Entity\Transmission;
use Knp\Bundle\PaginatorBundle\Pagination\SlidingPagination;
use Symfony\Component\HttpFoundation\Request;

class TransmissionHandlerTest extends BaseTestHandler
{
    public function setUp()
    {
        $this->className = 'IMS\CommonBundle\Entity\Transmission';
    ...
    public function testGetList()
    {
        ...
        $handler = new TransmissionHandler($this->em, $this->className);
    ...
    {
        $this->repo
            ->shouldReceive('find')->with(1)->andReturn(new Transmission());
    ...
    {
        $this->repo
            ->shouldReceive('findOneBy')->with(['column' => 'value'])->andReturn(new Transmission());
    ...
    public function testPost()
    {
        ...
        $this->setUpProcessForm($request, $method, TransmissionType::class);
    ...
    public function testPatch()
    {
        ...
        $this->repo
            ->shouldReceive('find')->with($id)->andReturn(new Transmission());
