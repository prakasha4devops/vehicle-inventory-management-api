...
use ApiBundle\Handler\EquipmentHandler;
use IMS\CommonBundle\Entity\Equipment;
use Knp\Bundle\PaginatorBundle\Pagination\SlidingPagination;
use \Mockery as m;
use Symfony\Component\HttpFoundation\Request;

class EquipmentTestHandlerTest extends BaseTestHandler
{
    public function setUp()
    {
        $this->className = 'IMS\CommonBundle\Entity\Equipment';
        $this->repoName = 'AppBundle\Repository\EquipmentRepository';
    ...
    public function testGetList()
    {
        ...
        $handler = new EquipmentHandler($this->em, $this->className);
    ...
    {
        $this->query
            ->shouldReceive('getOneOrNullResult')->andReturn(new Equipment());
    ...
    public function testPost()
    {
        ...
        $this->setUpProcessForm($request, $method, EquipmentType::class);
