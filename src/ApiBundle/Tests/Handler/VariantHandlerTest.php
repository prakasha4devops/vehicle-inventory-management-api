...
use Mockery as m;
use ApiBundle\Handler\VariantHandler;
use IMS\CommonBundle\Entity\Variant;
use Knp\Bundle\PaginatorBundle\Pagination\SlidingPagination;
use Symfony\Component\HttpFoundation\Request;

class VariantHandlerTest extends BaseTestHandler
{
    public function setUp()
    {
        $this->className = 'IMS\CommonBundle\Entity\Variant';
    ...
    public function testGetList()
    {
        ...
        $handler = new VariantHandler($this->em, $this->className);
    ...
    {
        $this->repo
            ->shouldReceive('find')->with(1)->andReturn(new Variant());
    ...
    {
        $this->repo
            ->shouldReceive('findOneBy')->with(['column' => 'value'])->andReturn(new Variant());
    ...
    public function testPost()
    {
        ...
        $this->setUpProcessForm($request, $method, VariantType::class);
    ...
    public function testPatch()
    {
        ...
        $this->repo
            ->shouldReceive('find')->with($id)->andReturn(new Variant());
