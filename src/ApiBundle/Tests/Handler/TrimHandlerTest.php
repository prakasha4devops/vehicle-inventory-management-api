...
use Mockery as m;
use ApiBundle\Handler\TrimHandler;
use IMS\CommonBundle\Entity\Trim;
use Knp\Bundle\PaginatorBundle\Pagination\SlidingPagination;
use Symfony\Component\HttpFoundation\Request;

class TrimHandlerTest extends BaseTestHandler
{
    public function setUp()
    {
        $this->className = 'IMS\CommonBundle\Entity\Trim';
    ...
    public function testGetList()
    {
        ...
        $handler = new TrimHandler($this->em, $this->className);
    ...
    {
        $this->repo
            ->shouldReceive('find')->with(1)->andReturn(new Trim());
    ...
    {
        $this->repo
            ->shouldReceive('findOneBy')->with(['column' => 'value'])->andReturn(new Trim());
    ...
    public function testPost()
    {
        ...
        $this->setUpProcessForm($request, $method, TrimType::class);
    ...
    public function testPatch()
    {
        ...
        $this->repo
            ->shouldReceive('find')->with($id)->andReturn(new Trim());
